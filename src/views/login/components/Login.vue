  ...
  >
    ...
    <template v-else-if="type === 'qrcode'">
      <div class="tip-container">
        ...
        <span class="refresh">{{ $t('pages.login.refresh') }} <IconRefresh class="refresh-icon"/> </span>
      </div>
    ...
    <template v-else>
      ...
      <a-form-item class="verification-code">
        <a-input class="input" v-model="formData.verifyCode" size="large"
...
const FORM_RULES: Record<string, FieldRule[]> = {
  ...
  verifyCode: [{required: true, message: t('pages.login.required.verification')}],
};
