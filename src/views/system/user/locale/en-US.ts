export default {
    ...
    //table 搜索
    'user.table.name.placeholder':'Please enter user name',
    'user.table.account.placeholder':'Please enter user account',
    'user.table.phone.placeholder':'Please enter user phone',
    ...
    //drawer 输入 placeholder
    'user.placeholder.name':'Please enter user name',
    'user.placeholder.account':'Please enter user account',
    'user.placeholder.phone':'Please enter user phone',
    'user.placeholder.email':'Please enter user email',
